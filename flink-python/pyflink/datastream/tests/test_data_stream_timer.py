...
#         kafka_producer = FlinkKafkaProducer("timer-stream-sink-4", SimpleStringSchema(),
#                                             producer_props)
...
#         # current_process_time = ctx.timer_service().current_processing_time()
