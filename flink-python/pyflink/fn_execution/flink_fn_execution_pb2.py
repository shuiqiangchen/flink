...
_USERDEFINEDDATASTREAMFUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key_type_info', full_name='org.apache.flink.fn_execution.v1.UserDefinedDataStreamFunction.key_type_info', index=2,
